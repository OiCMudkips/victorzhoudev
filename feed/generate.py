...
def generate_jp_entries(fg: FeedGenerator) -> None:
    fe1 = fg.add_entry()
    ...
    fe2.link(
        href="https://www.victorzhou.dev/jp_language_stuff/code_geass_episode_25.html",
    )
    fe2.published(datetime.datetime(year=2020, month=9, day=3, tzinfo=TIMEZONE))


def generate_rants_entries(fg: FeedGenerator) -> None:
    fe1 = fg.add_entry()
...
def generate_translation_of_fr_reasons(fg: FeedGenerator) -> None:
    fe1 = fg.add_entry()
    ...
    fe2.title(
        "English translation of reasons for judgment in Sinclair-Desgagné c. Procureur général du Canada, 2025 QCCS 2551",
    )
    ...
    fe3.title(
        "English translation of reasons for judgment in Sinclair-Desgagné c. Procureur général du Canada, 2025 QCCS 2556",
    )
    ...
    fe5.title(
        "English translation of reasons for judgment in R. c. Bandaogo, 2023 BCSC 2514",
    )
    ...
    fe6.title(
        "English translation of reasons for judgment in R. c. Grenier, 2024 BCSC 2600",
    )
    ...
    fe7 = fg.add_entry()
    fe7.id(
        "https://www.victorzhou.dev/translation_of_fr_reasons/2025-fc-114199-canlii.html",
    )
    fe7.title(
        "English translation of reasons for judgment in Droits collectifs Québec c. Canada (Cour suprême), 2025 CanLII 114199 (CF)",
    )
    fe7.link(
        href="https://www.victorzhou.dev/translation_of_fr_reasons/2025-fc-114199-canlii.html",
    )
    fe7.published(datetime.datetime(year=2026, month=3, day=16, tzinfo=TIMEZONE))

    fe8 = fg.add_entry()
    fe8.id(
        "https://www.victorzhou.dev/translation_of_fr_reasons/T-2936-24-court-file.html",
    )
    fe8.title("English translation of Federal Court file T-2936-24 document summary")
    fe8.link(
        href="https://www.victorzhou.dev/translation_of_fr_reasons/T-2936-24-court-file.html",
    )
    ...
    fe9.title(
        "English translation of reasons for judgment in R. c. Abdullah, 2024 BCSC 277",
    )
    fe9.link(
        href="https://www.victorzhou.dev/translation_of_fr_reasons/2024-bcsc-277.html",
    )
    fe9.published(datetime.datetime(year=2026, month=3, day=26, tzinfo=TIMEZONE))

    fe10 = fg.add_entry()
    fe10.id(
        "https://www.victorzhou.dev/translation_of_fr_reasons/T-2936-24-reasons-dated-20250707.html",
    )
    fe10.title(
        "English translation of reasons for judgment in Droits collectifs Québec c. Canada (Cour suprême), unpublished decision dated July 7, 2025",
    )
    fe10.link(
        href="https://www.victorzhou.dev/translation_of_fr_reasons/T-2936-24-reasons-dated-20250707.html",
    )
    fe10.published(datetime.datetime(year=2026, month=3, day=27, tzinfo=TIMEZONE))

    fe11 = fg.add_entry()
    fe11.id(
        "https://www.victorzhou.dev/translation_of_fr_reasons/T-2936-24-reasons-dated-20260115.html",
    )
    fe11.title(
    ...
    fe11.link(
        href="https://www.victorzhou.dev/translation_of_fr_reasons/T-2936-24-reasons-dated-20260115.html",
    )
...
def generate_transit_entries(fg: FeedGenerator) -> None:
    ...
    fe2.enclosure(
        url="https://cdn.victorzhou.dev/img/victoria_clipper/img1.jpg",
        type="image/jpeg",
    )
    fe2.published(datetime.datetime(year=2026, month=3, day=24, tzinfo=TIMEZONE))


def generate_se_entries(fg: FeedGenerator) -> None:
    fe1 = fg.add_entry()
...
def generate_travel_entries(fg: FeedGenerator) -> None:
    fe1 = fg.add_entry()
